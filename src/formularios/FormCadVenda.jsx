            ...
            <Row>
                ...
                <Container className="m-3 border">
                    <Row className="m-3">
                        ...
                        <Col>
                            <CaixaSelecao enderecoFonteDados={"http://localhost:3001/funcionario"}
                                campoChave={"codigo"}
                                campoExibicao={"nome"}
                            ...
                            <Row>
                                <Col md={1}>
                                    <Form.Group>
                                        ...
                                        <Form.Control type="text" value={FuncionarioSelecionado?.codigo} disabled />
                                    </Form.Group>
                                </Col>
                                <Col md={4}>
                                    <Form.Group>
                    ...
                    <Row className="mt-3">
                        ...
                        <TabelaItensVenda 
                            listaItens={ordem.itensOrdemDeServico}
                            setOrdem={setOrdem}
                            dadosOrdem={ordem}/>
                    </Row>
                </Container>
